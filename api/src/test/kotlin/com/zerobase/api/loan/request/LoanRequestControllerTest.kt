...
class LoanRequestControllerTest {
    ...
    @MockBean
    private lateinit var loanRequestServiceImp: LoanRequestServiceImp
    ...
    fun init() {
        ...
        loanRequestServiceImp = LoanRequestServiceImp(
            generateKey, userInfoRepository, encryptComponent, loanRequestSender
        )

        loanRequestController = LoanRequestController(loanRequestServiceImp)
